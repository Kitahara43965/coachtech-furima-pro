export class TransactionCommentSendButtonSvg {
    static getTransactionCommentSendButtonSvg(
        transactionCommentSendButtonSvgWidth,
        transactionCommentSendButtonSvgHeight,
    ) {
        return `
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
            width="${transactionCommentSendButtonSvgWidth}px" height="${transactionCommentSendButtonSvgHeight}px" viewBox="0 0 33 32" enable-background="new 0 0 33 32" xml:space="preserve">
            <g>
