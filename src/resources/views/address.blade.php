...
@section('content')
    <div class="address-board">
        ...
        <form 
            method="POST" 
            action="{{ route('purchase.address.update.itemId',['item_id'=>$itemId]) }}" 
        ...
        >
            ...
            <div class="form__group">
                @php
                    if($isFilledWithProfile){
                        $profilePostcode = $authUser->postcode;
                    }else{
                        $profilePostcode = null;
                    }
                    $embeddedDeliveryPostcode = $selectedPendingTypedPivot?->pivot?->delivery_postcode;
            ...
            <div class="form__group">
                @php
                    ...
                    $embeddedDeliveryAddress = $selectedPendingTypedPivot?->pivot?->delivery_address;
            ...
            <div class="form__group">
                @php
                    if($isFilledWithProfile){
                        $profileBuilding = $authUser->building;
                    }else{
                        $profileBuilding = null;
                    }
                    $embeddedDeliveryBuilding = $selectedPendingTypedPivot?->pivot?->delivery_building;
