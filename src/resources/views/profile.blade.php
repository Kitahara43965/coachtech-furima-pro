        ...
        <form method="POST" action="{{ route('mypage.profile.update') }}" enctype="multipart/form-data" novalidate>
            ...
            <div class="form__group">
                ...
                @php
                    ...
                    $embeddedImageName = $authUser?->image;
            ...
            <div class="form__group">
                @php
                    ...
                    $embeddedUserName = $authUser?->username;
            ...
            <div class="form__group">
                @php
                    ...
                    $embeddedPostcode = $authUser?->postcode;
            ...
            <div class="form__group">
                @php
                    ...
                    $embeddedAddress = $authUser?->address;
            ...
            <div class="form__group">
                @php
                    ...
                    $embeddedBuilding = $authUser->building;
