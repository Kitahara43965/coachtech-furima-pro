    ...
    <div class="evaluation-board">
        ...
        <div class="evaluation-right-block">
            ...
            <table class="item-table">
                <tr>
                    <th>
                        <form action="{{ route('item.favorite.itemId',['item_id' => $itemId]) }}" method="POST" novalidate>
                            @csrf
            ...
            <div>
                @if($authUserIdCoincidence)
                    <button
                        type="button"
                        class="evaluation-form__button-submit"
                        onclick="window.location='{{ route('item.edit.itemId',['item_id' => $itemId]) }}'">
                        編集
                    </button>
                @else
                    @if($isPurchased)
                    ...
                    @else
                        <button
                            type="button"
                            class="evaluation-form__button-submit"
                            onclick="window.location='{{ route('purchase.itemId',['item_id' => $itemId]) }}'">
                            購入手続きへ
                        </button>
                    @endif
                @endif
            ...
            <div>
                ...
                <div>
                    <form action="{{ route('item.comments.itemId', ['item_id' => $itemId]) }}" method="POST" novalidate>
                        @csrf
                        <div>
                            <textarea
                                name="description"
